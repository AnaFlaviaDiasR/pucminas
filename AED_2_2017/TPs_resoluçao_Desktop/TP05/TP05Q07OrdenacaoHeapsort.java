...
class Lista {
  ...
  /**
   * Metodo para contruir a heap
   * @param tam int
  */
   public void constroi(int tam){
     for(int i= tam; (i > 1) && (compara(array[i], array[i/2]) == 1); i /= 2){
     swap(i, i/2);
     }
   }//fim constroi

  /**
    * Metodo para reconstruir a heap
  */
   public void reconstroi(int tamHeap){
     ...
     while(i <= (tamHeap/2)){
       ...
       if( (compara(array[2*i], array[2*i+1]) == 1) || (2*i == tamHeap)){
          filho = 2*i;
       } else {
          filho = 2*i + 1;
       }

       if(compara(array[i], array[filho]) == -1){
          swap(i, filho);
          i= filho;
       }else{
          i= tamHeap;
   ...
   /**
    * Metodo para ordenar o arranjo usando o algoritmo de ordenacao Heapsort.
   */
   public void heapsort() {
     Series[] aux = new Series[n+1]; //Alterar o vetor ignorando a posicao zero
    ...
    /**
     * Metodo para comparar as duas series passadas por parametro
     * @param a Series
     * @param b Series
     * @return resp int
     * resp= -1 se menor, resp= 0 se igual, resp= 1 se maior
    */
    public int compara(Series a, Series b){
      int resp= 0;
      String fa= a.getFormato();
      String fb= b.getFormato();
    ...
    /**
    * Metodo para trocar os parametros de posicao
    * @param i
    * @param j
    */
...
class TP05Q07OrdenacaoHeapsort{
    ...
    Lista lista= new Lista(200);//referente a classe Lista

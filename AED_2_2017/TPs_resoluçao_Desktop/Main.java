...
class Lista{
  ...
  /**
   ...
   /**
    * Realiza pesquia de forma Binária
    * @param String
    * @return boolean
    */
...
public class Main{
	public static void main(String[] args) throws Exception{
	  ...
	  lista.selecao();
	  for(str = MyIO.readLine();!str.equals("FIM");str = MyIO.readLine()){
	  	MyIO.println(lista.pesquisaBinaria(str) ? "SIM" : "NÃO");
	  }// End for
	  double fim = now();
	  int comparacoes = lista.contNumeroComparacoes();
	  createFile(576920,comparacoes,fim-inicio);
	}// End main()
  ...
  /**
    ...
    */
	public static void createFile(int matricula,int comparacoes,double tempo) throws Exception{
		FileWriter file = new FileWriter("matrícula_binaria");
